...
###!!! django-admin не працює на compose треба вручну змінювати назву проекта в воркері
#### 1\. Клонування репозиторію

Для початку, склонуйте репозиторій із шаблоном собі на комп'ютер:

```bash
git clone https://github.com/KuthikBohdan1/django_celery_postgres_docker_template
```
